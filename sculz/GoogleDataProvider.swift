...
@objc class GoogleDataProvider : NSObject{
  ...
  let apiKey = "AIzaSyCWfeOS5E-liTelTRbYbam25USzQ2TpY_Y"
  ...
  @objc func fetchPlacesNearCoordinate(coordinate: CLLocationCoordinate2D, radius: Double, types:[String], completion: (([GooglePlace]) -> Void)) -> ()
  {
  ...
  @objc func fetchDirectionsFrom(from: CLLocationCoordinate2D, to: CLLocationCoordinate2D, completion: ((String?) -> Void)) -> ()
  {
  ...
  @objc func fetchPhotoFromReference(reference: String, completion: ((UIImage?) -> Void)) -> ()
  {
